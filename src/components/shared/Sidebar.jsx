    ...
    <div className="w-[260px] bg-[#1a1a1a] h-screen flex flex-col justify-between border-r border-[#333] shrink-0">
      ...
      <div>
        ...
        <div
          ...
          className="flex items-center gap-3 p-6 cursor-pointer border-b border-[#333]"
        >
          <img
            src={logo}
        ...
        <nav className="flex flex-col mt-6 px-4 gap-2">
          ...
          {navItems.map((item) => (
            ...
            <button
              ...
              className={`flex items-center gap-4 px-4 py-4 rounded-xl font-semibold transition-colors duration-200 ${
                isActive(item.path)
      ...
      >
        ...
        <button
          ...
          className="w-full bg-[#F6B100] text-[#1f1f1f] rounded-lg py-3 mt-8 font-bold hover:bg-yellow-500"
        >
          Create Order
        </button>
      </Modal>
